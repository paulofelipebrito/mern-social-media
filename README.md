...
[🔗**https://app-social-media.netlify.app**][deploy-url]
...
<p style="display: flex; align-items: flex-start; justify-content: center;">
  <img alt="socialmedia" title="#socialmedia" src="./src/assets/demo.gif" > 

</p>
</div>

Welcome to the _GitHub repository_ of my **Social Media** project! Here you can find information about the project's development, such as which technologies were used, how to install and run the project, usage and more.
...
1. Clone the repo
   ```sh
   git clone https://github.com/paulofelipebrito/mern-social-media
   ```
...
Project Link: [https://github.com/paulofelipebrito/mern-social-media](https://github.com/paulofelipebrito/mern-social-media)
...
[deploy-url]: https://app-social-media.netlify.app